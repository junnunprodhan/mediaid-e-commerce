function DashboardCards() {
  return (
    <>
      <div className=" grid gap-5 my-5 grid-cols-1 md:grid-cols-2 xl:grid-cols-4 mx-auto ">
        <div className="px-4 py-6 shadow-lg  rounded shadow-blue-100 flex justify-between items-center">
          <div>
        ...
        <div className="px-4 py-6 shadow-lg rounded shadow-blue-100 flex items-center justify-between">
          <div>
